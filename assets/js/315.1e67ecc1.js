...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _baseClone_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1641);
...
var mermaid_b5860b54 = __webpack_require__(6079);
...
/* harmony export */ });
/* harmony import */ var _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6079);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6312);
/* harmony import */ var _createText_2e5e7dd3_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(114);
...
let vertexCounter = 0;
let config = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.c)();
let vertices = {};
let edges = [];
let classes = {};
let subGraphs = [];
...
let version;
let funs = [];
const sanitizeText = (txt) => _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.e.sanitizeText(txt, config);
...
const addVertex = function(_id, textObj, type, style, classes2, dir, props = {}) {
  ...
  vertexCounter++;
  if (textObj !== void 0) {
    config = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.c)();
...
const addSingleLink = function(_start, _end, type) {
  ...
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.l.info("abc78 Got edge...", edge);
  ...
  if (edges.length < (config.maxEdges ?? 500)) {
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.l.info("abc78 pushing edge...");
    edges.push(edge);
  } else {
    throw new Error(
...
const addLink = function(_start, _end, type) {
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.l.info("addLink (abc78)", _start, _end, type);
  let i, j;
...
const updateLink = function(positions, style) {
  positions.forEach(function(pos) {
    ...
    if (pos === "default") {
      ...
      if (_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.u.isSubstringInArray("fill", style) === -1) {
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if ((0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.c)().securityLevel !== "loose") {
    return;
  }
    ...
    funs.push(function() {
      ...
      if (elem !== null) {
        elem.addEventListener(
          "click",
          function() {
            _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.u.runFunc(functionName, ...argList);
          },
          false
        );
      }
...
const setLink = function(ids, linkStr, target) {
  ids.split(",").forEach(function(id) {
    if (vertices[id] !== void 0) {
      vertices[id].link = _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.u.formatUrl(linkStr, config);
...
const clear = function(ver = "gen-1") {
  ...
  version = ver;
  config = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.c)();
  (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.v)();
};
const setGen = (ver) => {
  version = ver || "gen-2";
};
...
const addSubGraph = function(_id, list, _title) {
  ...
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.l.info("Adding", subGraph.id, subGraph.nodes, subGraph.dir);
...
const flowDb = {
  defaultConfig: () => _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.K.flowchart,
  setAccTitle: _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.s,
  getAccTitle: _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.g,
  getAccDescription: _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.a,
  setAccDescription: _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.b,
  addVertex,
  lookUpDomId,
  addLink,
  ...
  exists,
  makeUniq,
  setDiagramTitle: _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.q,
  getDiagramTitle: _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_1__.t
};
...
// EXTERNAL MODULE: ./node_modules/mermaid/dist/flowDb-956e92f1.js
var flowDb_956e92f1 = __webpack_require__(5860);
// EXTERNAL MODULE: ./node_modules/dagre-d3-es/src/graphlib/index.js
var graphlib = __webpack_require__(697);
...
// EXTERNAL MODULE: ./node_modules/mermaid/dist/styles-c10674c1.js
var styles_c10674c1 = __webpack_require__(5900);
...
const addVertices = async function(vert, g, svgId, root, _doc, diagObj) {
  ...
  for (const id of keys) {
    ...
    const styles = (0,mermaid_b5860b54.k)(vertex.styles);
    let vertexText = vertex.text !== void 0 ? vertex.text : vertex.id;
    let vertexNode;
    if ((0,mermaid_b5860b54.m)((0,mermaid_b5860b54.c)().flowchart.htmlLabels)) {
      const node = {
        label: await (0,mermaid_b5860b54.r)(
          vertexText.replace(
            /fa[blrs]?:fa-[\w-]+/g,
            // cspell:disable-line
            (s) => `<i class='${s.replace(":", " ")}'></i>`
          ),
          (0,mermaid_b5860b54.c)()
        )
      };
      ...
      const rows = vertexText.split(mermaid_b5860b54.e.lineBreakRegex);
      for (const row of rows) {
    ...
    mermaid_b5860b54.l.warn("Adding node", vertex.id, vertex.domId);
...
const addEdges = async function(edges, g, diagObj) {
  ...
  if (edges.defaultStyle !== void 0) {
    const defaultStyles = (0,mermaid_b5860b54.k)(edges.defaultStyle);
  ...
  for (const edge of edges) {
    ...
    if (edge.style !== void 0) {
      const styles = (0,mermaid_b5860b54.k)(edge.style);
      style = styles.style;
      labelStyle = styles.labelStyle;
    } else {
      switch (edge.stroke) {
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,mermaid_b5860b54.n)(edge.interpolate, src/* curveLinear */.lUB);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,mermaid_b5860b54.n)(edges.defaultInterpolate, src/* curveLinear */.lUB);
    } else {
      edgeData.curve = (0,mermaid_b5860b54.n)(conf.curve, src/* curveLinear */.lUB);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
      ...
      if ((0,mermaid_b5860b54.m)((0,mermaid_b5860b54.c)().flowchart.htmlLabels)) {
        ...
        edgeData.label = `<span id="L-${linkId}" class="edgeLabel L-${linkNameStart}' L-${linkNameEnd}" style="${edgeData.labelStyle}">${await (0,mermaid_b5860b54.r)(
          edge.text.replace(
            /fa[blrs]?:fa-[\w-]+/g,
            // cspell:disable-line
            (s) => `<i class='${s.replace(":", " ")}'></i>`
...
const getClasses = function(text, diagObj) {
  mermaid_b5860b54.l.info("Extracting classes");
  return diagObj.db.getClasses();
};
const draw = async function(text, id, _version, diagObj) {
  mermaid_b5860b54.l.info("Drawing flowchart");
  const { securityLevel, flowchart: conf2 } = (0,mermaid_b5860b54.c)();
  let sandboxElement;
  ...
  mermaid_b5860b54.l.warn("Get vertices", vert);
  ...
  (0,mermaid_b5860b54.o)(g, svg, conf2.diagramPadding, conf2.useMaxWidth);
  const keys = Object.keys(vert);
...
const diagram = {
  parser: flowDb_956e92f1.p,
  db: flowDb_956e92f1.f,
  renderer: styles_c10674c1.f,
  styles: styles_c10674c1.a,
  init: (cnf) => {
    if (!cnf.flowchart) {
      cnf.flowchart = {};
    }
    ...
    flowDb_956e92f1.f.clear();
    flowDb_956e92f1.f.setGen("gen-1");
  }
};
...
/* harmony import */ var _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6079);
/* harmony import */ var _index_3862675e_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8995);
...
const addVertices = async function(vert, g, svgId, root, doc, diagObj) {
  ...
  for (const id of keys) {
    ...
    const styles = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.k)(vertex.styles);
    let vertexText = vertex.text !== void 0 ? vertex.text : vertex.id;
    let vertexNode;
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.l.info("vertex", vertex, vertex.labelType);
    if (vertex.labelType === "markdown") {
      ...
      if ((0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.m)((0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.c)().flowchart.htmlLabels)) {
        ...
        const svgLabel = doc.createElementNS("http://www.w3.org/2000/svg", "text");
        svgLabel.setAttribute("style", styles.labelStyle.replace("color:", "fill:"));
        const rows = vertexText.split(_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.e.lineBreakRegex);
        for (const row of rows) {
          const tspan = doc.createElementNS("http://www.w3.org/2000/svg", "tspan");
          tspan.setAttributeNS("http://www.w3.org/XML/1998/namespace", "xml:space", "preserve");
          tspan.setAttribute("dy", "1em");
    ...
    const labelText = await (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.r)(vertexText, (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.c)());
    g.setNode(vertex.id, {
      labelStyle: styles.labelStyle,
      shape: _shape,
      labelText,
      ...
      type: vertex.type,
      props: vertex.props,
      padding: (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.c)().flowchart.padding
    });
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.l.info("setNode", {
      labelStyle: styles.labelStyle,
      labelType: vertex.labelType,
      shape: _shape,
      labelText,
...
const addEdges = async function(edges, g, diagObj) {
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.l.info("abc78 edges = ", edges);
  let cnt = 0;
  let linkIdCnt = {};
  let defaultStyle;
  let defaultLabelStyle;
  if (edges.defaultStyle !== void 0) {
    const defaultStyles = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.k)(edges.defaultStyle);
    defaultStyle = defaultStyles.style;
    defaultLabelStyle = defaultStyles.labelStyle;
  }
  for (const edge of edges) {
    ...
    if (linkIdCnt[linkIdBase] === void 0) {
      ...
      _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    } else {
      linkIdCnt[linkIdBase]++;
      _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.l.info("abc78 new entry", linkIdBase, linkIdCnt[linkIdBase]);
    }
    let linkId = linkIdBase + "-" + linkIdCnt[linkIdBase];
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.l.info("abc78 new link id to be used is", linkIdBase, linkId, linkIdCnt[linkIdBase]);
    const linkNameStart = "LS-" + edge.start;
    const linkNameEnd = "LE-" + edge.end;
    ...
    if (edge.style !== void 0) {
      const styles = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.k)(edge.style);
      style = styles.style;
      labelStyle = styles.labelStyle;
    }
    ...
    if (edge.interpolate !== void 0) {
      edgeData.curve = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.n)(edge.interpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    } else if (edges.defaultInterpolate !== void 0) {
      edgeData.curve = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.n)(edges.defaultInterpolate, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    } else {
      edgeData.curve = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.n)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_1__/* .curveLinear */ .lUB);
    }
    if (edge.text === void 0) {
      if (edge.style !== void 0) {
        edgeData.arrowheadStyle = "fill: #333";
    ...
    edgeData.label = await (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.r)(edge.text.replace(_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.e.lineBreakRegex, "\n"), (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.c)());
    if (edge.style === void 0) {
      edgeData.style = edgeData.style || "stroke: #333; stroke-width: 1.5px;fill:none;";
    }
    edgeData.labelStyle = edgeData.labelStyle.replace("color:", "fill:");
...
const draw = async function(text, id, _version, diagObj) {
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Drawing flowchart");
  let dir = diagObj.db.getDirection();
  if (dir === void 0) {
    dir = "TD";
  }
  const { securityLevel, flowchart: conf2 } = (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.c)();
  const nodeSpacing = conf2.nodeSpacing || 50;
  const rankSpacing = conf2.rankSpacing || 50;
  let sandboxElement;
  if (securityLevel === "sandbox") {
  ...
  let subG;
  const subGraphs = diagObj.db.getSubGraphs();
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Subgraphs - ", subGraphs);
  for (let i2 = subGraphs.length - 1; i2 >= 0; i2--) {
    subG = subGraphs[i2];
    _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Subgraph - ", subG);
  ...
  const vert = diagObj.db.getVertices();
  const edges = diagObj.db.getEdges();
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Edges", edges);
  let i = 0;
  for (i = subGraphs.length - 1; i >= 0; i--) {
    subG = subGraphs[i];
    (0,d3__WEBPACK_IMPORTED_MODULE_1__/* .selectAll */ .Ubm)("cluster").append("text");
    for (let j = 0; j < subG.nodes.length; j++) {
      _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.l.info("Setting up subgraphs", subG.nodes[j], subG.id);
  ...
  const svg = root.select(`[id="${id}"]`);
  const element = root.select("#" + id + " g");
  await (0,_index_3862675e_js__WEBPACK_IMPORTED_MODULE_4__.r)(element, g, ["point", "circle", "cross"], "flowchart", id);
  _mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.u.insertTitle(svg, "flowchartTitleText", conf2.titleTopMargin, diagObj.db.getDiagramTitle());
  (0,_mermaid_b5860b54_js__WEBPACK_IMPORTED_MODULE_2__.o)(g, svg, conf2.diagramPadding, conf2.useMaxWidth);
  diagObj.db.indexNodes("subGraph" + i);
  if (!conf2.htmlLabels) {
    const labels = doc.querySelectorAll('[id="' + id + '"] .edgeLabel .label');
    for (const label of labels) {
